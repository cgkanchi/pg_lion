...
setup
{
    ...
    CREATE INDEX ser_k ON ser USING roaring (k);
}
teardown
{
    DROP TABLE ser;
...
step s1_func    { SELECT roaring_index_count('ser_k', 99); }
...
step s2_func    { SELECT roaring_index_count('ser_k', 99); }
