...
# tree, start the benchmark cluster on a private endpoint, create the roaring indexes, run the query
...
bench_psql -c "drop extension if exists roaring_index cascade" >/dev/null
